...
import (
	...
	"github.com/evmos/ethermint/x/bitcoinindexer/client/cli"
...
// marshaled to json.RawMessage. The default GenesisState need to be defined by the module developer and is primarily used for testing
...
func (am AppModule) InitGenesis(ctx sdk.Context, cdcc codec.JSONCodec, gs json.RawMessage) []abci.ValidatorUpdate {
	var genState types.GenesisState
	// Initialize global index to index in genesis state
	cdcc.MustUnmarshalJSON(gs, &genState)
...
func (am AppModule) ExportGenesis(ctx sdk.Context, cdcc codec.JSONCodec) json.RawMessage {
	genState := ExportGenesis(ctx, am.keeper)
	return cdcc.MustMarshalJSON(genState)
}
